            ...
            if n>0:
                ...
                for edgey in tree.edges:
                    if not edgey[0]==0:
                        ...
                        total_dependecy_length+=dep_distance_real+1
                        ...
                        results2.close()
                result=open('Dependency-length-minimization.csv','a')
                result.write(str(lang)+"\t"+str(sent_id)+"\t"+str(n)+"\t"+str(total_dependecy_length)+"\n")
